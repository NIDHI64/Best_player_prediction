...
country <- read.csv("C:\\Users\\devit\\OneDrive\\Documents\\country.csv")
country
league <- read.csv("C:\\Users\\devit\\OneDrive\\Documents\\league.csv")
league
Match_1 <- read.csv("C:\\Users\\devit\\OneDrive\\Documents\\Match_1.csv")
Match_1
player <- read.csv("C:\\Users\\devit\\OneDrive\\Documents\\player.csv")
player
player_attributes <- read.csv("C:\\Users\\devit\\OneDrive\\Desktop\\player_attributes.csv")
player_attributes
team <- read.csv("C:\\Users\\devit\\OneDrive\\Documents\\team.csv")
team
